...
suite('Pint Transformer Accpetance: support_resources_views_components_button_blade_php', () => {
    test('pint: it can format support_resources_views_components_button_blade_php', () => {
        const input = `@props([
    'color' => 'primary',
    'disabled' => false,
    'form' => null,
