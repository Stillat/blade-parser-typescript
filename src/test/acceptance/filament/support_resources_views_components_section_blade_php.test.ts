...
suite('Pint Transformer Accpetance: support_resources_views_components_section_blade_php', () => {
    test('pint: it can format support_resources_views_components_section_blade_php', () => {
        const input = `@props([
    'aside' => false,
    'collapsed' => false,
    'collapsible' => false,
