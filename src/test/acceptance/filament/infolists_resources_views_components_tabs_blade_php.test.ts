...
suite('Pint Transformer Accpetance: infolists_resources_views_components_tabs_blade_php', () => {
    test('pint: it can format infolists_resources_views_components_tabs_blade_php', () => {
        const input = `<div
    x-data="{
