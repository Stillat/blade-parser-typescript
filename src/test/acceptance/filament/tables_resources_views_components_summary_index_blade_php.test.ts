...
suite('Pint Transformer Accpetance: tables_resources_views_components_summary_index_blade_php', () => {
    test('pint: it can format tables_resources_views_components_summary_index_blade_php', () => {
        const input = `@props([
    'actions' => false,
