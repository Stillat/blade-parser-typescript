...
suite('Pint Transformer Accpetance: infolists_resources_views_components_entry_wrapper_hint_blade_php', () => {
    test('pint: it can format infolists_resources_views_components_entry_wrapper_hint_blade_php', () => {
        const input = `@props([
    'actions' => [],
    'color' => null,
    'icon' => null,
