...
suite('Pint Transformer Acceptance: actions_resources_views_components_group_blade_php', () => {
    setupTestHooks();
    test('pint: it can format actions_resources_views_components_group_blade_php', async () => {
        const input = `@props([
    'actions' => [],
    'button' => false,
    'color' => null,
