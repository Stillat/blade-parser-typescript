...
suite('Pint Transformer Acceptance: forms_resources_views_components_tabs_blade_php', () => {
    setupTestHooks();
    test('pint: it can format forms_resources_views_components_tabs_blade_php', async () => {
        const input = `<div
    x-data="{
