...
suite('Pint Transformer Acceptance: panels_resources_views_components_resources_relation_managers_blade_php', () => {
    setupTestHooks();
    test('pint: it can format panels_resources_views_components_resources_relation_managers_blade_php', async () => {
        const input = `@props([
    'activeManager',
    'content' => null,
