...
suite('Pint Transformer Acceptance: panels_resources_views_components_global_search_result_group_blade_php', () => {
    setupTestHooks();
    test('pint: it can format panels_resources_views_components_global_search_result_group_blade_php', async () => {
        const input = `@props([
    'label',
    'results',
])
