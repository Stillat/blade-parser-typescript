...
suite('Pint Transformer Acceptance: panels_resources_views_components_layouts_app_topbar_badge_blade_php', () => {
    setupTestHooks();
    test('pint: it can format panels_resources_views_components_layouts_app_topbar_badge_blade_php', async () => {
        const input = `@props([
    'active' => false,
    'badge' => null,
    'badgeColor' => null,
