...
suite('Pint Transformer Accpetance: forms_resources_views_components_date_time_picker_blade_php', () => {
    test('pint: it can format forms_resources_views_components_date_time_picker_blade_php', () => {
        const input = `@php
