...
suite('Pint Transformer Accpetance: panels_resources_views_components_layouts_card_blade_php', () => {
    test('pint: it can format panels_resources_views_components_layouts_card_blade_php', () => {
        const input = `@props([
    'after' => null,
    'heading' => null,
    'subheading' => null,
