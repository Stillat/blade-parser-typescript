...
suite('Pint Transformer Accpetance: forms_resources_views_components_tags_input_blade_php', () => {
    test('pint: it can format forms_resources_views_components_tags_input_blade_php', () => {
