...
suite('Pint Transformer Accpetance: panels_resources_views_components_layouts_app_sidebar_group_blade_php', () => {
    test('pint: it can format panels_resources_views_components_layouts_app_sidebar_group_blade_php', () => {
        const input = `@props([
    'parentGroup' => null,
    'collapsible' => true,
    'icon' => null,
