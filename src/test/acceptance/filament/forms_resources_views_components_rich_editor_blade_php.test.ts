...
suite('Pint Transformer Acceptance: forms_resources_views_components_rich_editor_blade_php', () => {
    setupTestHooks();
    test('pint: it can format forms_resources_views_components_rich_editor_blade_php', async () => {
