...
suite('Pint Transformer Accpetance: support_resources_views_components_dropdown_list_item_blade_php', () => {
    test('pint: it can format support_resources_views_components_dropdown_list_item_blade_php', () => {
        const input = `@props([
    'color' => 'primary',
    'detail' => null,
    'disabled' => false,
