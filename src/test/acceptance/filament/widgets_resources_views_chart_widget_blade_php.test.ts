...
suite('Pint Transformer Accpetance: widgets_resources_views_chart_widget_blade_php', () => {
    test('pint: it can format widgets_resources_views_chart_widget_blade_php', () => {
        const input = `@php
