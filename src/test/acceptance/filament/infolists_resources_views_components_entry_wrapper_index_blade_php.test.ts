...
suite('Pint Transformer Acceptance: infolists_resources_views_components_entry_wrapper_index_blade_php', () => {
    setupTestHooks();
    test('pint: it can format infolists_resources_views_components_entry_wrapper_index_blade_php', async () => {
        const input = `@props([
    'entry' => null,
    'action' => null,
    'alignment' => null,
