...
suite('Pint Transformer Acceptance: panels_resources_views_components_page_blade_php', () => {
    setupTestHooks();
    test('pint: it can format panels_resources_views_components_page_blade_php', async () => {
        const input = `@php
