...
suite('Pint Transformer Accpetance: panels_resources_views_components_layouts_app_topbar_index_blade_php', () => {
    test('pint: it can format panels_resources_views_components_layouts_app_topbar_index_blade_php', () => {
        const input = `@props([
    'breadcrumbs' => [],
    'navigation',
])
