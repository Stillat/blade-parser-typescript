...
suite('Pint Transformer Acceptance: panels_resources_views_components_global_search_result_blade_php', () => {
    setupTestHooks();
    test('pint: it can format panels_resources_views_components_global_search_result_blade_php', async () => {
        const input = `@props([
    'actions' => [],
    'details' => [],
    'title',
