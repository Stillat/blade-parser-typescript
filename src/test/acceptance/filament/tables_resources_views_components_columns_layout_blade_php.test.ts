...
suite('Pint Transformer Accpetance: tables_resources_views_components_columns_layout_blade_php', () => {
    test('pint: it can format tables_resources_views_components_columns_layout_blade_php', () => {
        const input = `@props([
    'components',
    'record',
    'recordKey' => null,
