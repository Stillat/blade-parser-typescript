...
suite('Pint Transformer Accpetance: tables_resources_views_columns_toggle_column_blade_php', () => {
    test('pint: it can format tables_resources_views_columns_toggle_column_blade_php', () => {
        const input = `@php
    $state = $getState();
@endphp
