...
suite('Pint Transformer Acceptance: panels_resources_views_components_user_menu_blade_php', () => {
    setupTestHooks();
    test('pint: it can format panels_resources_views_components_user_menu_blade_php', async () => {
        const input = `@php
