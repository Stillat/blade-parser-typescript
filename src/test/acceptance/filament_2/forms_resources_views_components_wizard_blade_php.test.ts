...
suite('Pint Transformer Accpetance: forms_resources_views_components_wizard_blade_php', () => {
    test('pint: it can format forms_resources_views_components_wizard_blade_php', () => {
        const input = `@php
    ...
    >
        @foreach ($getChildComponentContainer()->getComponents() as $step)
            ...
            >
                ...
                >
                    ...
                    <div class="flex items-center gap-3 px-5 py-4 text-sm font-medium">
                        ...
                        <div class="flex flex-col items-start justify-center">
                            <div
                                class="filament-forms-wizard-component-header-step-label text-sm font-semibold tracking-wide uppercase"
                            >
                                {{ $step->getLabel() }}
                            </div>
                ...
                @if (! $loop->first)
                    <div
                        class="absolute inset-0 top-0 left-0 hidden w-3 md:block"
                        aria-hidden="true"
                    >
                        <svg
                            @class([
