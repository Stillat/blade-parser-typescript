...
suite('Pint Transformer Acceptance: support_resources_views_components_modal_index_blade_php', () => {
    setupTestHooks();
    test('pint: it can format support_resources_views_components_modal_index_blade_php', async () => {
        const input = `@props([
    'actions' => null,
    'ariaLabelledby' => null,
    'closeButton' => true,
