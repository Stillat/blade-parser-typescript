...
suite('Pint Transformer Acceptance: admin_resources_views_components_widget_blade_php', () => {
    setupTestHooks();
    test('pint: it can format admin_resources_views_components_widget_blade_php', async () => {
        const input = `@php
