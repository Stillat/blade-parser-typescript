...
suite('Pint Transformer Acceptance: forms_resources_views_component_container_blade_php', () => {
    setupTestHooks();
    test('pint: it can format forms_resources_views_component_container_blade_php', async () => {
        const input = `<x-filament-support::grid
...
`;
        const output = `<x-filament-support::grid
    :default="$getColumns('default')"
    :sm="$getColumns('sm')"
    :md="$getColumns('md')"
    :lg="$getColumns('lg')"
