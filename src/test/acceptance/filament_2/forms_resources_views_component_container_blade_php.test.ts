...
suite('Pint Transformer Accpetance: forms_resources_views_component_container_blade_php', () => {
    test('pint: it can format forms_resources_views_component_container_blade_php', () => {
