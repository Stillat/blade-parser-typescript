...
suite('Pint Transformer Accpetance: admin_resources_views_components_layouts_app_topbar_user_menu_blade_php', () => {
    test('pint: it can format admin_resources_views_components_layouts_app_topbar_user_menu_blade_php', () => {
        const input = `@php
