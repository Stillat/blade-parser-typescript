...
suite('Pint Transformer Accpetance: forms_resources_views_components_actions_modal_index_blade_php', () => {
    test('pint: it can format forms_resources_views_components_actions_modal_index_blade_php', () => {
        const input = `@php
