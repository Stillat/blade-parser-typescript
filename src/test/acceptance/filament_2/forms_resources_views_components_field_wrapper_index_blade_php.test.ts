...
suite('Pint Transformer Accpetance: forms_resources_views_components_field_wrapper_index_blade_php', () => {
    test('pint: it can format forms_resources_views_components_field_wrapper_index_blade_php', () => {
        const input = `@props([
    'id',
    'label' => null,
    'labelPrefix' => null,
