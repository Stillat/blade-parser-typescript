...
suite('Pint Transformer Accpetance: admin_resources_views_components_resources_relation_managers_index_blade_php', () => {
    test('pint: it can format admin_resources_views_components_resources_relation_managers_index_blade_php', () => {
        const input = `@props([
    'activeManager',
    'form' => null,
    'formTabLabel' => null,
