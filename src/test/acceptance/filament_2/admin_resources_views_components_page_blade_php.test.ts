...
suite('Pint Transformer Acceptance: admin_resources_views_components_page_blade_php', () => {
    setupTestHooks();
    test('pint: it can format admin_resources_views_components_page_blade_php', async () => {
        const input = `@props([
    'modals' => null,
    'widgetData' => [],
])
