...
suite('Pint Transformer Accpetance: admin_resources_views_components_card_index_blade_php', () => {
    test('pint: it can format admin_resources_views_components_card_index_blade_php', () => {
        const input = `@props([
    'actions' => null,
    'footer' => null,
    'header' => null,
