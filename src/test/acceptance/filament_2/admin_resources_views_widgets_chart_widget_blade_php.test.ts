...
suite('Pint Transformer Accpetance: admin_resources_views_widgets_chart_widget_blade_php', () => {
    test('pint: it can format admin_resources_views_widgets_chart_widget_blade_php', () => {
        const input = `@php
