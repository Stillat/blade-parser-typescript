...
suite('Pint Transformer Acceptance: notifications_resources_views_components_dropdown_item_blade_php', () => {
    setupTestHooks();
    test('pint: it can format notifications_resources_views_components_dropdown_item_blade_php', async () => {
