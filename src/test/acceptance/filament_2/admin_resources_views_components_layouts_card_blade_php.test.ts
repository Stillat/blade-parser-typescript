...
suite('Pint Transformer Acceptance: admin_resources_views_components_layouts_card_blade_php', () => {
    setupTestHooks();
    test('pint: it can format admin_resources_views_components_layouts_card_blade_php', async () => {
        const input = `@props([
    'title' => null,
    'width' => 'md',
])
