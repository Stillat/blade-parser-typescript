...
suite('Pint Transformer Accpetance: forms_resources_views_components_placeholder_blade_php', () => {
    test('pint: it can format forms_resources_views_components_placeholder_blade_php', () => {
