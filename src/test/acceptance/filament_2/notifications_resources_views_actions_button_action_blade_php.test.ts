...
suite('Pint Transformer Acceptance: notifications_resources_views_actions_button_action_blade_php', () => {
    setupTestHooks();
    test('pint: it can format notifications_resources_views_actions_button_action_blade_php', async () => {
