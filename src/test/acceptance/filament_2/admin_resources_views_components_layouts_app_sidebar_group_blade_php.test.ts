...
suite('Pint Transformer Acceptance: admin_resources_views_components_layouts_app_sidebar_group_blade_php', () => {
    setupTestHooks();
    test('pint: it can format admin_resources_views_components_layouts_app_sidebar_group_blade_php', async () => {
        const input = `@props([
    'parentGroup' => null,
    'collapsible' => true,
    'icon' => null,
