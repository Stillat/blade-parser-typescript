...
suite('Pint Transformer Accpetance: admin_resources_views_components_layouts_app_sidebar_group_blade_php', () => {
    test('pint: it can format admin_resources_views_components_layouts_app_sidebar_group_blade_php', () => {
        const input = `@props([
    'parentGroup' => null,
    'collapsible' => true,
    'icon' => null,
        ...
        >
            ...
            >
                @if ($icon)
                    <x-dynamic-component
                        :component="$icon"
                        class="ml-1 w-3 h-3 flex-shrink-0"
                    />
                @endif
