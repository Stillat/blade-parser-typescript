...
suite('Pint Transformer Acceptance: tables_resources_views_components_dropdown_item_blade_php', () => {
    setupTestHooks();
    test('pint: it can format tables_resources_views_components_dropdown_item_blade_php', async () => {
