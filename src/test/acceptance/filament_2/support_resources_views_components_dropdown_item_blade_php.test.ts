...
suite('Pint Transformer Acceptance: support_resources_views_components_dropdown_item_blade_php', () => {
    setupTestHooks();
    test('pint: it can format support_resources_views_components_dropdown_item_blade_php', async () => {
