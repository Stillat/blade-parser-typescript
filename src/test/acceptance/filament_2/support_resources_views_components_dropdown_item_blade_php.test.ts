...
suite('Pint Transformer Accpetance: support_resources_views_components_dropdown_item_blade_php', () => {
    test('pint: it can format support_resources_views_components_dropdown_item_blade_php', () => {
