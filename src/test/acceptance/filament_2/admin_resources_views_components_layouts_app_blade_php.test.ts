...
suite('Pint Transformer Acceptance: admin_resources_views_components_layouts_app_blade_php', () => {
    setupTestHooks();
    test('pint: it can format admin_resources_views_components_layouts_app_blade_php', async () => {
        const input = `@props([
