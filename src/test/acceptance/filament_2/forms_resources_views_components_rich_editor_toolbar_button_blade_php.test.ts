...
suite('Pint Transformer Accpetance: forms_resources_views_components_rich_editor_toolbar_button_blade_php', () => {
...
`;
    ...
    {{
        $attributes->class([
            'filament-forms-rich-editor-component-toolbar-button focus:ring-primary-200 h-full cursor-pointer rounded-lg border border-gray-300 bg-white px-3 py-1 text-sm font-medium text-gray-800 shadow-sm transition duration-200 hover:bg-gray-100 focus:ring focus:ring-opacity-50',
